        ...
        <div class="product-card" data-product-id="${product.id}">
            <div class="product-image-wrapper">
                ...
                <div class="product-overlay">
                    <button class="quick-view-btn"><i class="bi bi-eye"></i>상세보기</button>
...
if (document.querySelector('.products-grid')) {
    ...
    if (searchQuery) {
        ...
        if (!productsGrid.querySelector('.product-card[data-product-id]')) {
            ...
            // 상품 그리드에 로드
            // 전체 다 보여주고 싶으면:
            loadProducts(null, uniqueProducts);

            // 만약 최대 16개까지만 보이고 싶으면 위 줄 대신 아래 사용:
            // loadProducts(null, uniqueProducts.slice(0, 16));
        } else {
