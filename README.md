# Elexa(일렉사) - 프리미엄 쇼핑몰 프로젝트

## 프로젝트 개요

### 프로젝트 주제
**프리미엄 전자제품 쇼핑몰 웹사이트** - 사용자 친화적인 인터페이스와 완전한 반응형 디자인을 갖춘 전자상거래 플랫폼
...
### 주요 타겟 사용자
- **주 사용자**: 전자제품 구매를 원하는 일반 소비자 (20-50대)
...
**구현 방법**:
- **추천스토리 슬라이더**: `setInterval`로 5초마다 자동 전환, 호버 시 일시정지
